...
- (NSString *) GraphqlQueryForUserFilter:(NSString *) keyWord{
    ...
    [finalKeyWord appendString:@" type:user"];
...
- (NSString *) GraphqlQueryForOrgFilter:(NSString *) keyWord{
    ...
    [finalKeyWord appendString:@" type:org"];
...
- (NSString *) GraphqlQueryForIssueFilter:(NSString *) keyWord{
    ...
    [finalKeyWord appendFormat:@" is:issue archived:false is:%@",self.issueOrPRClosed ? @"closed" : @"open"];
...
- (NSString *) GraphqlQueryForPullRequestFilter:(NSString *) keyWord{
    ...
    [finalKeyWord appendFormat:@" is:pr archived:false is:%@",self.issueOrPRClosed ? @"closed" : @"open"];
