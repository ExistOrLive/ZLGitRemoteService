...
public extension ZLGithubHttpClientV2 {
    ...
    ///    - repoName: 仓库名 githubclient
    ///    - ref:  commit sha
    @objc func getCommitDiffForRepo(login: String,
                                 repoName: String,
                                 ref: String,
                                 serialNumber: String,
                                 response: @escaping GithubResponseSwift) {
        let api = ZLGithubAPISwift.getCommitDiffForRepo(login: login, repoName: repoName, ref: ref)
        self.requestGithubAPI(api: api, serialNumber: serialNumber, responseBlock: response)
    }
    ...
    ///    - repoName: 仓库名 githubclient
    ///    - ref:  commit sha
    @objc func getCommitCompareForRepo(login: String,
                                       repoName: String,
                                       baseRef: String,
                                       headRef: String,
                                       page: Int = 1,
                                       ...
                                       serialNumber: String,
                                       response: @escaping GithubResponseSwift) {
        let api = ZLGithubAPISwift.getCommitCompareForRepo(login: login,
                                                           repoName: repoName,
                                                           baseRef: baseRef,
                                                           headRef: headRef,
